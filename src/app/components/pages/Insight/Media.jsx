...
//               For all media inquiries, press releases, or interview requests,
//               please reach out to our dedicated media relations team. We are
//               happy to provide insights into{" "}
//               <strong>Distil Education & Technology's</strong> initiatives,
  ...
  return (
    <div className="py-16 bg-white overflow-hidden">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-[1120px]">
        {/* Heading Animation */}
        <motion.h1
          className="font-serif font-bold text-center text-3xl sm:text-4xl md:text-5xl mb-12 text-blue-950"
        ...
        >
          ...
          {/* Right Image Section */}
          <motion.div
            className="flex-1 w-full lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0 group"
            variants={{
              hidden: { opacity: 0, x: 60 },
              show: { opacity: 1, x: 0, transition: { duration: 0.8, ease: "easeOut" } },
            }}
