...
//     {
//       initial: "D",
//       name: "Distil Education & Technology Pvt Ltd",
//       color: "red",
//     },
...
//       ],
//       image1: {
//         src: "/img/Peopleimg.png",
//         alt: "Peopleimg.png",
//         width: 438,
//         height: 332,
//       },
//       image2: {
//         src: "/img/People1img.png",
//         alt: "People1img.png",
//         width: 354,
//         height: 610,
//       },
...
//       ],
//       image1: {
//         src: "/img/people21.png",
//         alt: "people21.png",
//         width: 438,
//         height: 332,
//       },
//       image2: {
//         src: "/img/people22.png",
//         alt: "people22.png",
//         width: 354,
//         height: 610,
//       },
...
//       ],
//       image1: {
//         src: "/img/people31.png",
//         alt: "people31.png",
//         width: 438,
//         height: 332,
//       },
//       image2: {
//         src: "/img/people32.png",
//         alt: "people32.png",
//         width: 354,
//         height: 610,
//       },
...
//       ],
//       image1: {
//         src: "/img/people41.png",
//         alt: "people41.png",
//         width: 438,
//         height: 332,
//       },
//       image2: {
//         src: "/img/people42.png",
//         alt: "people42.png",
//         width: 354,
//         height: 610,
//       },
...
//       ],
//       image1: {
//         src: "/img/people51.png",
//         alt: "people51.png",
//         width: 438,
//         height: 332,
//       },
//       image2: {
//         src: "/img/people52.png",
//         alt: "people52.png",
//         width: 354,
//         height: 610,
//       },
...
//         <div
//           className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 lg:p-12 
...
//             <span className="mx-4">
//               Helped <span className="font-semibold text-blue-600">12.5L+</span>{" "}
//               trainees placed
//             </span>
//             <span className="flex-grow border-t border-gray-300"></span>
//           </p>
...
//             Why People love{" "}
//             <span className="text-red-600">Distil Education?</span>
//           </h1>
...
//                       className="rounded-lg shadow-xl object-cover w-full h-auto transition-transform duration-700 ease-in-out hover:scale-105"
//                     />
//                   </div>

//                   <div className="flex justify-center items-center w-full lg:w-[354px] overflow-hidden rounded-lg">
//                     <Image
...
import React, { useState } from "react";
import Image from "next/image";
import familyData from "../../../../../public/db/familyData.json";

const Family = () => {
  const [activeTab, setActiveTab] = useState("Industry Engagement");

  const { familySection, peopleSection } = familyData;
  const activeData = peopleSection.tabs[activeTab];
  const tabNames = Object.keys(peopleSection.tabs);
  ...
  return (
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <section className="bg-gray-900 py-20 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 lg:p-12 relative z-20 -mb-[12vh]">
          <h2 className="text-center font-bold text-xl md:text-2xl text-gray-800 mb-2">
            {familySection.pillars.title}
          </h2>
          <p className="flex items-center justify-center text-lg md:text-xl text-gray-600 mb-8">
            <span className="flex-grow border-t border-gray-300"></span>
            <span className="mx-4">
              {familySection.pillars.highlight.text}
            </span>
            <span className="flex-grow border-t border-gray-300"></span>
          </p>
          ...
          {/* Companies */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-10">
            {familySection.pillars.companies.map((company, index) => {
              const { bg, text } = getColorClasses(company.color);
              return (
                <div
                  key={index}
          ...
          <div className="text-center">
            <button
              className={`inline-flex items-center justify-center px-12 py-3 
                         bg-${familySection.pillars.button.bgColor} text-white font-semibold text-lg rounded-lg shadow-md
                         hover:bg-${familySection.pillars.button.hoverColor} transition duration-300`}
            >
              {familySection.pillars.button.text}
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full z-10">
        <div className="max-w-[1290px] mx-auto bg-white rounded-2xl shadow-lg p-8 mt-16">
          <h1 className="text-center font-bold text-[24px] sm:text-[28px] md:text-[32px] leading-[110%] text-red-600 mb-10">
            {peopleSection.title}
          </h1>
              ...
              {activeData && (
                <>
                  <div className="w-full lg:w-[500px] lg:pr-10 mb-10 lg:mb-0">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-6 text-gray-800">
                      {activeData.title}{" "}
                      <span className="text-red-600">{activeData.highlight}</span>
                    </h2>
