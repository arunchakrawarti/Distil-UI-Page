...
const Design = () => {
  ...
  return (
    <div className="relative max-w-[1330px] mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-16">
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6 sm:gap-8 lg:gap-10 w-full max-w-6xl -mt-20 sm:-mt-24 md:-mt-28 lg:-mt-22 z-10">
        ...
        <button className="mt-8 sm:mt-10 px-12 lg:px-24 sm:px-20 py-2 lg:py-4 sm:py-3 bg-blue-900 text-white font-semibold text-base sm:text-lg rounded-lg shadow-xl hover:bg-blue-800 transition duration-300">
          Get Started
        </button>
      </div>
    </div>
