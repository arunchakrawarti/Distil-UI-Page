...
//       <div className='relative w-full max-w-[1120px] h-[348px] mx-auto rounded-xl overflow-hidden shadow-2xl bg-gray-200 group'>
...
//           className="object-cover object-center transition-transform duration-[2000ms] ease-in-out group-hover:scale-110"
//           priority
//         />
