  ...
  return (
    <div className="bg-[#FFEFEB] w-full  mx-auto py-20 px-4 sm:px-6 lg:px-8">
      ...
      <p className="font-sans font-normal text-base sm:text-lg md:text-[18px] leading-relaxed sm:leading-7 md:leading-[28px] text-center max-w-3xl mx-auto mb-8">
        At Distil, we are dedicated to revolutionizing education through innovation, strategic partnerships, and a deep commitment to student success. Explore our diverse initiatives designed to shape the leaders of tomorrow.
      </p>
